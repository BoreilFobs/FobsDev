...
class QuoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'project_type' => 'required|in:site_web,e_commerce,application_web,application_mobile,refonte,autre',
            ...
            'deadline' => 'required|in:2_semaines,1_mois,2_mois,3_mois_plus,flexible',
