...
@section('page-title', 'Nouveau Lead')
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body" style="padding: 25px;">
            <form action="{{ route('dashboard.leads.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        @error('maps_link')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Lien unique vers la localisation Google Maps de l'entreprise</small>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Décrivez l'entreprise et les opportunités potentielles</small>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" 
                            ...
                            @foreach(App\Models\Lead::getStatuses() as $value => $label)
                                <option value="{{ $value }}" {{ old('status', 'not_touched') == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Notes privées non visibles par le client</small>
                    </div>
                </div>

                <div class="d-flex gap-3 mt-4">
                    <button type="submit" class="btn btn-gradient flex-fill">
                        <i class="bi bi-save me-2"></i>Créer le Lead
                    </button>
                    <a href="{{ route('dashboard.leads.index') }}" class="btn btn-outline-secondary" style="width: auto;">
                        Annuler
                    </a>
                </div>
            </form>
